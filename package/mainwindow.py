...
from package.optimization.team_optimizer import find_optimal_team_sat, create_team_df
from package.analysis.opportunity_cost import calc_player_oc
from package.data.repositories import save_draft_state, load_most_recent_draft_state
...
class MainWindow(qtw.QWidget):  # Would be something else if you didn't use widget above
    ...
    def export_draft(self):
        save_draft_state(self.draft_df)

    def import_draft(self):
        df = load_most_recent_draft_state()
        if df is None:
            return
        self.draft_df = df
...
# Moved to package.analysis.opportunity_cost.calc_player_oc
...
# Moved to package.optimization.team_optimizer.find_optimal_team_sat


# Moved to package.optimization.team_optimizer.create_team_df
